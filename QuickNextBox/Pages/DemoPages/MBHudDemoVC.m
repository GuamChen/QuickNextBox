...
- (void) viewDidLoad {
    ...
    self.tableView.tableFooterView = [UIView new]; // 去除空cell的分割线
    self.tableView.estimatedRowHeight = 44; // 预估行高
    self.tableView.rowHeight = UITableViewAutomaticDimension; // 自动行高
    ...
    self.titleLb.text = @"MBHudDemoView";
    self.titleLb.textColor = [UIColor blackColor];
    self.titleLb.font = FONT(20);
